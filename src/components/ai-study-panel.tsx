...
export function AiStudyPanel({variantId,totalPages,initialPage,config}:{variantId:string;totalPages:number|null;initialPage:number;config:AiPanelConfig}){
 ...
 return <aside className="min-w-0"><details className="surface-card sticky top-4"><summary className="min-h-11 cursor-pointer text-lg font-semibold">{p.ai}</summary>
