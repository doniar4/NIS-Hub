...
<<<<<<< HEAD
export async function ReadingList({bookmarks=false,limit}:{bookmarks?:boolean;limit?:number}){
 ...
 return <ul className="divide-y divide-[var(--line)]">{entries.slice(0,limit).map(entry=>{
=======
