...
export async function v05Database() {
 ...
 try {
  for(const name of ["202609120002_phase4_books.sql","202609120003_phase4_weekly_schedule.sql","202609140001_v05_school_calendar.sql","202609140002_v05_schedule_versions.sql"])
